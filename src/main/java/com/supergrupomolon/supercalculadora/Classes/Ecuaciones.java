...
public class Ecuaciones {
     ...
     * @return Devuelve un ArrayList con dos valores, 1 o ninguno en función de los
     *         parametros dados
     */
     ...
     * @return Devolverá un string erroneo si el calculo por Ruffini no es exacto, y
     *         un string con el resultado correcto si encuentra la solución
     */
    public ArrayList<Integer> ecuacionesSuperiores(int grado) {
